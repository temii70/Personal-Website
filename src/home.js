...
{/* Left Section */}
<img src= "/newheadshot.jpg" alt= "Temi Otun" className=" self-center -mt-10 mb-6 md:mb-0 w-60 h-60 sm:w-96 sm:h-96 md:w-[26rem] md:h-[26rem] object-cover object-center "/>
{/* Bio Section */}
