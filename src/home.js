...
<main
  ...
  style={{ backgroundImage: "url('/vegas-1.webp')" }}
>
...
{/* Left Section */}
<img src= "/headshot2.webp" alt= "Temi Otun" className=" self-center -mt-10 mb-6 md:mb-0 w-60 h-60 sm:w-96 sm:h-96 md:w-[26rem] md:h-[26rem] object-cover object-center "/>
...
<p className= "text-base leading-relaxed text-left " style={{fontFamily:" 'Work Sans',sans-serif"}}
  ...
  transition={{duration: 0.8, ease: "easeOut"}}> I’m a Computer Science student specializing in Artificial Intelligence at the University of Alberta. I work with C, Python, and SQL, and I have experience applying machine learning and deep learning to real-world challenges.</p>
...
{/* right */}
 ...
 <section id="Projects" ref={vantaRef} className="min-h-screen relative text-white px-8 pt-40 font-sans sm:pb-96 md:pb-24 lg:pb-24   " style={{fontFamily:" 'Work Sans',sans-serif"}}>
